...
public class CMB extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        caseTittle = intent.getStringExtra("case");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FirebaseDatabase.getInstance()
                        .getReference("messages").child(caseTittle)
                        .push()
    ...
    private void displayChatMessages() {
        ...
        adapter = new FirebaseListAdapter<ChatMessage>(this, ChatMessage.class,
                R.layout.message, FirebaseDatabase.getInstance().getReference("messages").child(caseTittle)) {
            @Override
